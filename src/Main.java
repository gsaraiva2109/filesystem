...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Comandos: mkdir  rmdir  mvdir  touch  cp  rm  mv  ls  log  exit");
        ...
        while (true) {
            ...
            switch (cmd) {
                case "mkdir":
                    ...
                    break;
                case "rmdir":
                    if (parts.length < 2) { System.out.println("Uso: rmdir <caminho>"); break; }
                    fs.deleteDirectory(parts[1]);
                    break;
                case "mvdir":
                    if (parts.length < 3) { System.out.println("Uso: mvdir <caminho> <novo-nome>"); break; }
                    fs.renameDirectory(parts[1], parts[2]);
                    break;
                case "touch":
                    if (parts.length < 2) { System.out.println("Uso: touch <caminho>"); break; }
                    fs.createFile(parts[1]);
                    break;
                case "cp":
                    if (parts.length < 3) { System.out.println("Uso: cp <origem> <destino>"); break; }
                ...
                case "rm":
                    ...
                    break;
                case "mv":
                    if (parts.length < 3) { System.out.println("Uso: mv <caminho> <novo-nome>"); break; }
